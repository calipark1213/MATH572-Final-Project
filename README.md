Epidemic modelling is the field of modelling the spread of disease via tools from multiple disciplines
such as mathematics, statistics, and computer science. It uses a combination of data and
...
such as having efforts in place for a higher vaccination coverage. It was found that by maximizing
vaccine coverage and efficiency, the number of cumulative cases within group 1 and group 2
decreased by 45.11% and 6.89%, respectively. This project will aid individuals in understanding
population dynamics during periods of an influenza infection.

To view full report: Math_572_Project.pdf

To view briefing note: Briefing Note.pdf
